...
def find_matches(hand: str) -> List[int]:
    ...
    Jokers being wild cards, their count is added on to whatever is already the most common card in the hand
    ...
    num_jacks = card_counter[0]
    card_counter = card_counter[1:]
    card_counter[card_counter.index(max(card_counter))] += num_jacks
